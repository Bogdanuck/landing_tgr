  ...
  return (
    <div className="bg-[#eff1f7] min-h-screen overflow-x-hidden">
      ...
      <section className="pt-10 pb-20 text-center relative overflow-visible">
        ...
        <div className="absolute left-0 bottom-[-300px] h-[600px] w-[800px] pointer-events-none z-0">
        ...
        <div className="absolute right-0 bottom-[-200px] h-full w-[600px] pointer-events-none z-0">
          <div className="absolute bottom-0 w-full h-full">
            <img 
        ...
        <div className="max-w-[961px] mx-auto relative z-20">
          ...
          <h1 className="text-[40px] leading-[1.3] font-medium text-[#0C172C] mb-6">
            Первый маркетплейс по покупке рекламы в Telegram Mini Apps
          </h1>
          
          <p className="text-[22px] text-[#0C172C] font-normal mb-8">
            Прозрачность вместо хаоса
          </p>

          <Button className="h-[75px] px-8 rounded-[18px] bg-[#2A67DC] mx-auto">
      ...
      {/* Stats Banner */}
      <div className="max-w-[1020px] mx-auto h-[140px] bg-[#071019] rounded-[32px] relative mb-20 overflow-hidden z-10">
        ...
        <div className="flex items-center justify-center h-full">
          <p className="text-[32px] font-medium">
            ...
            <span className="text-[#EBEEF4]"> от</span>
      ...
      {/* Info Banner */}
      <div className="w-full bg-[#ffffff66] border-y border-white py-[30px] mb-20 relative z-10">
      ...
      {/* For Whom Section */}
      <section id="for-whom" className="bg-[#0C172C] py-[140px] mb-20">
        <div className="max-w-[1362px] mx-auto relative">
          <div className="absolute w-[290px] h-80 top-0 left-[166px] opacity-50">
          ...
          <div className="flex flex-col w-[545px] items-start gap-[30px] absolute top-0 right-0">
            <h2 className="font-medium text-white text-5xl leading-[57.6px]">
              Для кого предназначен TrafficGram?
            </h2>
          ...
          <div className="grid grid-cols-4 gap-[30px] pt-[339px]">
            {forWhomCards.map((card, index) => (
              <Card key={index} className="w-[318px] h-[301px] bg-[#1B263B] rounded-[18px] overflow-hidden border-none">
      ...
      <section id="uniqueness" className="max-w-[1360px] mx-auto mb-20">
        <div className="grid grid-cols-2 gap-[30px]">
          <div>
            <Card className="bg-[#ffffff66] rounded-[32px] border border-solid border-white p-10 mb-[30px]">
              <CardContent className="p-0">
                <h2 className="font-medium text-[#0C172C] text-5xl leading-[57.6px]">
                  Чем мы уникальны?
                </h2>
              </CardContent>
            </Card>

            <Card className="bg-[#ffffff66] rounded-[32px] border border-solid border-white p-10">
              {uniqueFeatures.map((feature, index) => (
                <React.Fragment key={index}>
                  <div className="flex items-start gap-[31px]">
                    <div className="w-[126px] h-[126px] bg-white rounded-[18px] flex items-center justify-center shrink-0">
                      <img className="w-[72px] h-[72px]" alt={feature.title} src={feature.icon} />
                    </div>
                    <div className="flex flex-col gap-3.5">
                      <h3 className="font-medium text-[#0C172C] text-2xl leading-[28.8px]">
                        {feature.title}
                      </h3>
                  ...
                  {index < uniqueFeatures.length - 1 && (
                    <Separator className="w-full h-[1px] my-10" />
                  )}
                </React.Fragment>
              ))}
            </Card>
          ...
          <div className="space-y-[30px]">
            <Card className="bg-[#ffffff66] rounded-[32px] border border-solid border-white p-10">
              {moreUniqueFeatures.map((feature, index) => (
                <React.Fragment key={index}>
                  <div className="flex items-start gap-[31px]">
                    <div className="w-[126px] h-[126px] bg-white rounded-[18px] flex items-center justify-center shrink-0">
                      <img className="w-[76px] h-[76px]" alt={feature.title} src={feature.icon} />
                    </div>
                    <div className="flex flex-col gap-3.5">
                      <h3 className="font-medium text-[#0C172C] text-2xl leading-[28.8px]">
                        {feature.title}
            ...
            <Card className="bg-[#ffffff66] rounded-[32px] border border-solid border-white p-10 flex items-center justify-center">
      ...
      {/* How to Join Section */}
      <section id="how-to-join" className="max-w-[1362px] mx-auto mb-20 relative">
        <div className="absolute w-[1567px] h-[842px] top-0 left-[-1091px] bg-[#2A67DC0D] rounded-[783.5px/421px] -rotate-180 blur-[125px]" />

        <h2 className="font-medium text-[#0C172C] text-5xl leading-[57.6px] mb-[30px]">
          Как стать частью<br />
          системы?
        </h2>

        <div className="flex gap-[30px]">
          <Card className="w-[680px] p-10 bg-[#ffffff66] rounded-[32px] border border-solid border-white backdrop-blur-[23.25px]">
            {participationOptions.map((option, index) => (
              <React.Fragment key={index}>
                <div className="flex items-center gap-[31px]">
                  <div className="w-[126px] h-[126px] bg-white rounded-[18px] flex items-center justify-center">
                    <img className="w-[63px] h-[63px]" alt={option.title} src={option.icon} />
                  </div>
                  <div className="flex flex-col w-[395px] gap-[22px]">
                    <h3 className="font-medium text-[#0C172C] text-2xl leading-[28.8px]">
                      {option.title}
                    </h3>
                    <p className="font-normal text-[#566A8F] text-base leading-[22.4px]">
                ...
                {index < participationOptions.length - 1 && (
                  <Separator className="w-[552px] h-[1.5px] my-10" />
                )}
              </React.Fragment>
            ))}
            <Button className="w-full h-[55px] gap-2 mt-10 rounded-xl bg-[#2A67DC]">
              <img className="w-[25px] h-[25px]" alt="Join icon" src="/simplification.svg" />
              <span className="font-medium text-white text-[17px]">
                Присоединиться
              </span>
          ...
          <div className="w-[680px]">
            <img className="w-full" src="/human.svg" alt="Иллюстрация" />
          </div>
        </div>
      </section>

      {/* Final CTA Section */}
      <section className="w-full bg-white py-[140px] mb-20">
        <div className="max-w-[961px] mx-auto flex flex-col items-center gap-8">
          <div className="flex flex-col items-center gap-6 w-full">
            ...
            <h2 className="font-medium text-[40px] leading-[52px] text-center">
